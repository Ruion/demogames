...
public class Launcher : MonoBehaviour
{
    ...
    public string VersionsFileDownloadURL { get { return FindObjectOfType<JSONSetter>().Server_FTP + "/patch/patches/versions.txt"; } }
    ...
    public string BuildsDirectoryURL { get { return FindObjectOfType<JSONSetter>().Server_FTP + "/patch/builds/"; } }
    ...
    private void OnTaskCompleted(string message)
    {
        ...
        // Auto Launch Build.exe (game executable)
        LaunchButton_click();
    }
